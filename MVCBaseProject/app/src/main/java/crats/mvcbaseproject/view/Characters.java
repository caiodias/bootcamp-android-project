...
public class Characters extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Pair<ArrayList<Character>, Integer>> {
...
public void onLoadFinished(Loader<Pair<ArrayList<Character>, Integer>> loader, Pair<ArrayList<Character>, Integer> data) {
        ...
        total = data.second;
        adapter = new CharacterAdapter(Characters.this, characters);
